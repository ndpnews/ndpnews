			...
			<div class="row">
				<div class="col-md-8">
					<?php
						...
						$req = $bdd->query('SELECT id, titre, contenu, auteur, DATE_FORMAT(date, \'%d/%m/%Y à %Hh%i\') AS date_fr FROM articles WHERE categorie="tuto" ORDER BY date DESC LIMIT 0, 10');
